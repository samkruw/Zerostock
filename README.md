...
## V2.8 – Role Fix
- Rollenwert wird direkt aus `/users/<UID>/role` gelesen.
- `admin`, `employee`, `customer` werden getrimmt und kleingeschrieben.
- Rollenabruf wird bis zu dreimal versucht.
- Der Rollen-Screen zeigt den tatsächlich gelesenen Wert bzw. Firebase-Fehler.
- Button „Rolle erneut prüfen“ ohne erneuten Login.
- Service Worker v2.8 erzwingt frische App-Dateien bei Updates.
